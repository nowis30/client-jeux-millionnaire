...
const APK_URL = process.env.NEXT_PUBLIC_APK_URL || "https://github.com/nowis30/jeux-millionnaire-APK/releases/download/heritier-millionnaire/HeritierMillionnaire.apk"; // GitHub Releases
