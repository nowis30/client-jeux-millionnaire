...
const APK_URL = process.env.NEXT_PUBLIC_APK_URL || "https://github.com/nowis30/jeux-millionnaire-APK/raw/refs/heads/main/heritier-millionnaire-v1.0.apk"; // Direct link to file in repo
